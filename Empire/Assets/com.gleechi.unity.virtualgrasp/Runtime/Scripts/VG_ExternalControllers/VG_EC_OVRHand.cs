...
namespace VirtualGrasp.Controllers 
{
    ...
    [HelpURL("https://docs.virtualgrasp.com/unity_vg_ec_ovrhand." + VG_Version.__VG_VERSION__ + ".html")]
    public class VG_EC_OVRHand : VG_ExternalController 
    {
        ...
        public VG_EC_OVRHand(int avatarID, VG_HandSide side, Transform origin)
        {
            m_avatarID = avatarID;
            m_handType = side;            
			...
			m_enabled = true;
#else
            PrintNotEnabledError("VG_USE_OVRHAND_CONTROLLER");
            m_enabled = false;
#endif
        }
        ...
        {
            m_mapping = new VG_EC_OculusHand.HandMapping();
